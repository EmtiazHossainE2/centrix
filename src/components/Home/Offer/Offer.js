  ...
  return (
    <div className='container mx-auto section__padding ' id='offer'>
      <div className='offer__container'>
        <div className="offer__gradient-bg">
          <div className='grid grid-cols-1 lg:grid-cols-12 p-5 shadow-md rounded-md border border-[#121228]'>
            <div className="lg:col-span-5">
              ...
              <div className='mt-5 mb-5 lg:mb-0 w-[50px] h-[4px] bg-[#02e0b8]'/>
            </div>
